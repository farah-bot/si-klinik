                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tekanan_darah" placeholder="135 / 90 mm/Hg"
                                required>
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div>
                                <label class="radio-inline"><input type="radio" name="kepala_leher" value="Normal">
                                    Kepala</label>
                                <label class="radio-inline"><input type="radio" name="kepala_leher" value="Abnormal">
                                    Leher</label>
                            </div>
                        ...
                        <div class="form-group">
                            <label>B. Mata</label>
                            <div>
                                <label class="radio-inline"><input type="radio" name="mata" value="Normal">
                                    Normal</label>
                                <label class="radio-inline"><input type="radio" name="mata" value="Abnormal">
                                    Abnormal</label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <label class="radio-inline"><input type="radio" name="telinga" value="Normal">
                                    Normal</label>
                                <label class="radio-inline"><input type="radio" name="telinga" value="Abnormal">
                                    Abnormal</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div>
                                <label class="radio-inline"><input type="radio" name="hidung" value="Normal">
                                    Normal</label>
                                <label class="radio-inline"><input type="radio" name="hidung" value="Abnormal">
                                    Abnormal</label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <label class="radio-inline"><input type="radio" name="gigi_mulut" value="Normal">
                                    Normal</label>
                                <label class="radio-inline"><input type="radio" name="gigi_mulut" value="Abnormal">
                                    Abnormal</label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <label class="radio-inline"><input type="radio" name="faring_orofaring"
                                        value="Normal"> Normal</label>
                                <label class="radio-inline"><input type="radio" name="faring_orofaring"
                                        value="Abnormal"> Abnormal</label>
                            </div>
                        </div>
                    </div>
                </div>
