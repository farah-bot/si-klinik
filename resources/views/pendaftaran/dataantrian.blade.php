            ...
            <table class="table table-bordered" id="pasienTable">
                ...
                <tbody id="tableBody">
                    <tr>
                        ...
                        <td>Umum</td>
                        <td>
                            <button class="btn btn-warning" onclick="editPasien(1)"><i class="fas fa-edit"></i></button>
                            <button class="btn btn-danger" onclick="hapusPasien(1)"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
